...
Just a few weeks ago [@Mathot] released a great paper on pupillometry giving the reader a basic introduction to the method, along with guidelines on how to preprocess the data, and even offered a few suggestions on how to analyze the data (see their great figure below). This paper will for sure be something I revisit as well as give to folks interested in pupillometry. In the paper, they talk about fitting linear mixed models together with cross validation to test time points. While I think there are a lot of benefits of it (described in the paper), I could not stop thinking that the method fails to give researchers what they really want, the onsets and offsets of certain events. In the the cross-validation approach, it takes only the time points with highest Z scores and submits those points to a linear mixed model. Ultimately, you can say an effect is significant at X, Y, and Z times but cant really make any claims about the start and end of a cognitive event. This got me thinking about a paper I read a few years ago by [@yu_multi-time-point_2020] on a method called multi-time-point analysis which they applied to fNIRS data. I really liked the method and began thinking about all the ways it could be applied (EEG, pupillometry, etc.) In the paper, they showed that it is a more powerful tool than the often used mass univariate approach. Here I show how to apply this method to pupillometry data.
...
I have shown how to apply MTPA to pupillometric data. This method appears to be more powerful than a mass univariate approach, showing the whole time course as significant. It would be interesting to see how this compares to the method proposed by [@Mathot].
