...
categories: 
  ...
  - VWP 
pub-info:
  reference: "<strong>Geller, J.</strong>, Prystauka, Y., Colby, S. E., & Drouin, J. R. (in press). Language without borders: A step-by-step guide to analyzing webcam eye-tracking data for L2 research. <em> Research Methods in Applied Lingustics. </em> https://osf.io/preprints/psyarxiv/7jqea_v7"
  links:
    - name: Preprint
