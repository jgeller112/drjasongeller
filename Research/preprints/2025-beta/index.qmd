...
categories: 
  ...
  - learning and memory
pub-info:
  reference: "<strong>Geller, J.</strong>, Kubinec, R, Parlett, C., and Vuorre, M.(2025). A Beta way: A tutorial for using Beta regression in psychological research. https://doi.org/10.31234/osf.io/d6v5t_v4"
  links:
    - name: Preprint/HTML
